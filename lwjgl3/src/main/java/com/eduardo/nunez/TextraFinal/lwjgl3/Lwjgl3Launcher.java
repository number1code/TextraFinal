package com.eduardo.nunez.TextraFinal.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import com.eduardo.nunez.TextraFinal.MyGame;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("TextraFinal");
        ...
        // We leave a small margin (e.g., 30px) at the top for the title bar visibility
        var displayMode = Lwjgl3ApplicationConfiguration.getDisplayMode();
        // comment out to center for OBS recording
        configuration.setWindowPosition(displayMode.width - windowWidth, 30);
