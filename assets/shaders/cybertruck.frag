...
// Audio uniforms
uniform float u_beat;      // 0.0 to 1.0, impulsive
uniform float u_intensity; // 0.0 to 1.0, smoothed RMS

// --- COMBINED CODE FROM COMMON TAB ---
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // neon tubes
    // Climax controlled by beat now
    float climax = 1.0; // Steady rhythm for position changes
    ...
    beamCol *= (0.2 + u_beat * 1.5); // Punchy brightness on beat
