...
public class VoltageScreen extends ScreenAdapter {
    ...
    public VoltageScreen(Game game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        // --- 1. NEW FONT FAMILY CREATION for "Voltage" ---
        FreeTypeFontGenerator.FreeTypeFontParameter parameter = new FreeTypeFontGenerator.FreeTypeFontParameter();
        parameter.size = 52; // A solid base size
        ...
        // Load the new pixel font
        FreeTypeFontGenerator pixelGenerator = new FreeTypeFontGenerator(Gdx.files.internal("PressStart2P-Regular.ttf"));
        Font pixelFont = new Font(pixelGenerator.generateFont(parameter));
...
//        skin.add("default", fontFamily);
        ...
        // --- 4. Create and Position the TypingLabel ---
